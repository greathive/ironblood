...
@Mod("ironblood")
public class IronbloodMod {
	public static final Logger LOGGER = LogManager.getLogger(IronbloodMod.class);
	public static final String MODID = "ironblood";

	public IronbloodMod(FMLJavaModLoadingContext context) {
