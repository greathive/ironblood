...
public class IronbloodModBlocks {
	...
	public static final RegistryObject<Block> MECHANICAL_JOINT;
	public static final RegistryObject<Block> MECHANICAL_JOINTALT;
	static {
		MECHANICAL_JOINT = REGISTRY.register("mechanical_joint", MechanicalJointBlock::new);
		MECHANICAL_JOINTALT = REGISTRY.register("mechanical_jointalt", MechanicalJointaltBlock::new);
	}
