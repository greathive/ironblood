...
public class IronbloodModTabs {
	...
	public static final RegistryObject<CreativeModeTab> IRONBLOOD = REGISTRY.register("ironblood",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.ironblood.ironblood")).icon(() -> new ItemStack(IronbloodModBlocks.MECHANICAL_JOINT.get())).displayItems((parameters, tabData) -> {
